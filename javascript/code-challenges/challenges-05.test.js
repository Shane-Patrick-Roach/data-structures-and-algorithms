...
const addValues = (arr) => {
  let total = arr.reduce( function(bucket,value){
    bucket = bucket + value;
    return bucket;
  }, 0);
...
const addPurchases = (arr) => {
  let total = arr.reduce( function(bucket,value){
    bucket = bucket + value.purchasePrice;
    return bucket;
  }, 0);
...
const countNumberOfElements = (arr) => {
  let totalCount = arr.reduce ( function(counter){
    counter = counter + 1;
    return counter;
  }, 0);
...
const returnNames = (arr) => {
  let names = arr.reduce((list, char) => {
    list.push(char.name);
    return list;
  }, []);
...
const reversedString = (str) => {
  ...
  let reverse = splitStr.reduce((rev, char) => {
    return char+rev;
  }, '');
